...
namespace digioz.Portal.Web.Areas.Admin.Pages.LinkCategory
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(ILinkCategoryService service) { _service = service; }

        public IReadOnlyList<digioz.Portal.Bo.LinkCategory> Items { get; private set; } = Array.Empty<digioz.Portal.Bo.LinkCategory>();
