...
namespace digioz.Portal.Utilities.Helpers
{
    public static class Utility
    {
        ...
        public static List<string> CCGetCountryList()
        {
            List<string> countries = new List<string>();
        ...
        public static Dictionary<string, string> CCGetMonthList()
        {
            ...
            for (int i = 1; i < 13; i++)
            {
                ...
                monthDict.Add(val, val);
            }

            return monthDict;
        }

        public static List<string> CCGetYearList()
        {
