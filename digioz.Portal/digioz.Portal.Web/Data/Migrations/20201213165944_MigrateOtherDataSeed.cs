...
namespace digioz.Portal.Web.Data.Migrations
{
    public partial class MigrateOtherDataSeed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var siteEncryptionKey = StringUtils.GetUniqueKey(32);
            var encryptString = new EncryptString();
            var smtpPassword = encryptString.Encrypt(siteEncryptionKey, "Pass@word1");
            ...
            configs.Add(new Config() { Id = "7b35120d-0fb6-4829-9614-2855e48d532d", ConfigKey = "SMTPPassword", ConfigValue = smtpPassword, IsEncrypted = true });
            configs.Add(new Config() { Id = "29d234af-a801-44ec-b9e7-f9406bd886bd", ConfigKey = "SiteURL", ConfigValue = "https://localhost:44394/", IsEncrypted = false });
            ...
            configs.Add(new Config() { Id = "a32696b0-d05a-4cdc-b00d-c3415920de26", ConfigKey = "SiteEncryptionKey", ConfigValue = siteEncryptionKey, IsEncrypted = false });
            ...
            menus.Add(new Menu() { UserId = "b4280b6a-0613-4cbd-a9e6-f1701e926e73", Name = "Forum", Location = "TopMenu", Controller = "Forum", Action = "Index", Url = null, Target = null, Visible = false, SortOrder = 4, Timestamp = DateTime.Now });
            ...
            menus.Add(new Menu() { UserId = "b4280b6a-0613-4cbd-a9e6-f1701e926e73", Name = "Store", Location = "TopMenu", Controller = "Store", Action = "Index", Url = null, Target = null, Visible = false, SortOrder = 7, Timestamp = DateTime.Now });
            menus.Add(new Menu() { UserId = "b4280b6a-0613-4cbd-a9e6-f1701e926e73", Name = "Twitter", Location = "TopMenu", Controller = "Twitter", Action = "Index", Url = null, Target = null, Visible = false, SortOrder = 8, Timestamp = DateTime.Now });
